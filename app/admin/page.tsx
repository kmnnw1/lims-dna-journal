...
>(({ label, value, isSelect, children, className = '', ...props }, ref) => {
			...
			<div className="max-w-6xl mx-auto">
				...
				<div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
					...
					<form
						...
						<h2 className="mb-6 text-2xl font-normal tracking-tight">
							Новый пользователь
						</h2>
