      ...
      <div className="mb-6 grid grid-cols-1 gap-6 md:grid-cols-3">
        <div className="md:col-span-3 rounded-3xl border border-amber-200/80 bg-gradient-to-br from-amber-50 to-white p-6 shadow-sm dark:border-amber-900/40 dark:from-amber-950/40 dark:to-zinc-900">
          ...
          <p className="mb-4 text-sm text-zinc-600 dark:text-zinc-400">
            ...
            <code className="rounded bg-zinc-200/80 mx-1 px-1.5 py-0.5 font-mono text-xs dark:bg-zinc-800">data.xlsx</code>
            в корне каталога приложения на сервере. Перед загрузкой таблица проб очищается.
          </p>
        ...
        >
          ...
          <label className="flex flex-col gap-1 mb-4">
            <span className="text-xs text-zinc-600 dark:text-zinc-400 font-medium">Роль</span>
          ...
          <h2 className="mb-4 font-semibold flex items-center gap-2">
            ...
            {loadingUsers && (
              <span className="flex items-center gap-1 text-xs text-zinc-400">
                <svg className="animate-spin h-3 w-3 text-teal-500" viewBox="0 0 24 24">
