            ...
            <div className="max-w-6xl mx-auto">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
                    <div className="p-6 rounded-[2rem] bg-[var(--md-sys-color-surface-container-high)] border border-[var(--md-sys-color-outline-variant)]/30">
                        ...
                        <p className="text-3xl font-black text-[var(--md-sys-color-primary)]">{logs.length}</p>
                    </div>
                        ...
                        <table className="w-full text-left border-separate border-spacing-0">
                            <thead>
                                <tr className="bg-[var(--md-sys-color-surface-container)]">
                                    <th className="px-6 py-5 text-sm font-black uppercase tracking-widest text-[var(--md-sys-color-on-surface-variant)] opacity-70">Событие</th>
                                    <th className="px-6 py-5 text-sm font-black uppercase tracking-widest text-[var(--md-sys-color-on-surface-variant)] opacity-70">Пользователь</th>
                                    <th className="px-6 py-5 text-sm font-black uppercase tracking-widest text-[var(--md-sys-color-on-surface-variant)] opacity-70">Ресурс</th>
                                    <th className="px-6 py-5 text-sm font-black uppercase tracking-widest text-[var(--md-sys-color-on-surface-variant)] opacity-70">Время</th>
                                </tr>
                            </thead>
                                    ...
                                    <tr>
                                        <td colSpan={4} className="px-6 py-20 text-center">
                                            <div className="flex flex-col items-center gap-4">
                                                ...
                                                <p className="text-xl font-bold opacity-60">Анализ журналов...</p>
                                            </div>
                                        </td>
                                    </tr>
                                ) : logs.length === 0 ? (
                                    <tr>
                                        <td colSpan={4} className="px-6 py-20 text-center text-xl font-bold opacity-40">
                                            Журнал пуст
                                        </td>
                                    </tr>
                                ) : (
                                    logs.map((log) => (
                                        <tr key={log.id} className="hover:bg-[var(--md-sys-color-surface-container-lowest)] transition-colors group">
                                            ...
                                            <td className="px-6 py-5">
                                                <div className="flex items-center gap-2 font-medium">
                                                    ...
                                                    <span className={log.userId === 'admin' ? 'text-[var(--md-sys-color-primary)] font-black' : ''}>
                                                        {log.userId}
                                                    </span>
                                                </div>
                                            </td>
