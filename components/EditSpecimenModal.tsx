...
const MD3 = {
  ...
  input:
    "w-full rounded-2xl border-none bg-zinc-100/80 px-5 py-3.5 text-sm outline-none focus:ring-2 focus:ring-teal-600 focus:bg-white dark:bg-zinc-800 dark:focus:bg-zinc-900 transition-all placeholder:text-zinc-400/90 dark:placeholder:text-zinc-500",
  btnPrimary:
          ...
          <section className="bg-zinc-50 dark:bg-zinc-800/50 p-6 rounded-3xl">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <input
                ...
                onChange={(e) =>
                  onChange({ ...specimen, taxon: e.target.value })
                }
                className={MD3.input}
              />
              <input
          ...
          <section className="bg-zinc-50 dark:bg-zinc-800/50 p-6 rounded-3xl">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <input
                ...
                onChange={(e) =>
                  onChange({ ...specimen, extrLab: e.target.value })
                }
                className={MD3.input}
              />
              <input
