...
export function AnimatedFlask() {
    ...
    return (
        ...
        >
            ...
            <div className={`relative ${isAnimating ? 'rock-swirl' : ''}`} style={isAnimating ? { animationDuration: `${Math.max(0.2, 0.8 / Math.max(1, rockRef.current))}s` } : {}}>
                <svg
                    width="64"
                    height="64"
                    viewBox="0 0 24 24"
                ...
                >
                    <defs>
                        <linearGradient id="liquid-grad" x1="0%" y1="0%" x2="100%" y2="100%">
                            ...
                            <stop offset="100%" stopColor="var(--md-sys-color-primary)" stopOpacity="0.8" />
                        </linearGradient>
                        <path id="flask-inner-mask" d="M 10.3,10 L 13.7,10 L 21,21 A 1,1 0 0 1 20,22 H 4 A 1,1 0 0 1 3,21 Z" />
                    ...
                    <g clipPath="url(#flask-liquid-clip)">
                        <g className={isAnimating ? 'liquid-counter' : ''} style={isAnimating ? { animationDuration: `${Math.max(0.2, 0.8 / Math.max(1, rockRef.current))}s` } : {}}>
                            <rect x="0" y="10" width="24" height="15" fill="url(#liquid-grad)" stroke="none" />
                        </g>
                    </g>
                    ...
                    <g className="text-[var(--md-sys-color-on-surface)] group-hover:text-[var(--md-sys-color-primary)] transition-colors duration-500" fill="none">
                        <path
