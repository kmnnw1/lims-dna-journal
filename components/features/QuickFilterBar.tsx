		...
		<div className="relative flex items-center h-full" ref={dropdownRef}>
			<button
				...
				className={`flex items-center justify-center p-2 rounded-full transition-all duration-300 ${
					isOpen
						? 'bg-(--md-sys-color-primary) text-(--md-sys-color-on-primary) shadow-md'
				...
				<div className="absolute top-full right-0 mt-3 w-[340px] sm:w-[380px] z-100 bg-(--md-sys-color-surface-container-lowest) border border-(--md-sys-color-outline-variant)/60 rounded-3xl shadow-2xl overflow-hidden md-elevation-4 animate-in slide-in-from-top-4 fade-in duration-300">
					<div className="p-4 border-b border-(--md-sys-color-outline-variant)/30 flex items-center justify-between bg-(--md-sys-color-surface-container-low)">
						...
						<button
							...
							className="p-1 rounded-full hover:bg-(--md-sys-color-surface-container-highest) text-(--md-sys-color-outline) transition-colors"
						>
							<X className="w-5 h-5" />
						</button>
					</div>
					...
					<div className="p-5 space-y-6">
						...
						<div className="space-y-4">
							<div className="flex justify-between items-center">
								...
								<span className="text-xs font-semibold text-(--md-sys-color-primary) bg-(--md-sys-color-primary-container) px-2 py-0.5 rounded-full">
									{localMin} — {localMax} нг/мкл
								</span>
							</div>
							<div className="relative pt-4 px-2">
								{/* Real HTML5 dual slider hack or simple range */}
								<div className="relative h-2 rounded-full bg-(--md-sys-color-surface-container-high)">
									<div
										className="absolute h-full bg-(--md-sys-color-primary) rounded-full"
										style={{
								...
								<input
									...
									className="absolute w-full -top-1 left-0 h-4 bg-transparent appearance-none pointer-events-none [&::-webkit-slider-thumb]:pointer-events-auto [&::-webkit-slider-thumb]:w-4 [&::-webkit-slider-thumb]:h-4 [&::-webkit-slider-thumb]:rounded-full [&::-webkit-slider-thumb]:bg-white [&::-webkit-slider-thumb]:border-2 [&::-webkit-slider-thumb]:border-(--md-sys-color-primary) [&::-webkit-slider-thumb]:appearance-none"
								/>
								<input
									type="range"
									min="0"
