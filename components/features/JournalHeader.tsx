		...
		<header className="flex flex-col xl:flex-row justify-between items-start xl:items-center gap-6 mb-8">
			...
			<div className="flex flex-wrap items-center gap-3 w-full xl:w-auto">
				...
				<button
					...
					title="Тема"
					className="p-3.5 bg-[var(--md-sys-color-surface-container)] hover:bg-[var(--md-sys-color-surface-container-high)] rounded-full transition-all flex items-center justify-center">
				...
				<Link
					href="/admin"
					className="flex items-center gap-2 px-4 py-3.5 bg-[var(--md-sys-color-surface-container)] hover:bg-[var(--md-sys-color-surface-container-high)] rounded-[1rem] transition-all font-medium">
				...
				<button
					onClick={onSignOut}
					title="Выйти"
					className="p-3.5 bg-[var(--md-sys-color-surface-container)] hover:bg-[var(--md-sys-color-error-container)] hover:text-[var(--md-sys-color-on-error-container)] rounded-full transition-all flex items-center justify-center">
