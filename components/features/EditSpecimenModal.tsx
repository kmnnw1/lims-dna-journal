		...
		>
			<div className="my-6 w-full max-w-2xl p-6 sm:p-8 relative bg-[var(--md-sys-color-surface-container-low)] rounded-[2.5rem] shadow-2xl max-h-[90vh] overflow-y-auto custom-scrollbar">
				...
				<div className="mb-6 flex items-center justify-between gap-4">
					<h2 id="edit-modal-title" className="text-2xl sm:text-3xl font-normal text-[var(--md-sys-color-on-surface)] tracking-tight">
						Редактировать
				...
				<form onSubmit={onSubmit} className="space-y-6" autoComplete="off">
					<section className="bg-[var(--md-sys-color-surface-container)] p-5 sm:p-6 rounded-[2rem]">
